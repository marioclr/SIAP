...
'************************************************************
	...
	If FolderExists(sGeneralFolder, sErrorDescription) Then
		If Not FolderExists(sSpecificFolder, sErrorDescription) Then
			lErrorNumber = CreateFolder(sSpecificFolder, sErrorDescription)
		End If
	...
	If Len(oRequest("Add").Item) > 0 Then
		...
		If lErrorNumber = 0 Then
			Response.Write "<SCRIPT LANGUAGE=""JavaScript""><!--" & vbNewLine
				Response.Write "window.location.replace('EmployeeSupport.asp?Action=Paperworks&New=1');" & vbNewLine
			Response.Write "//--></SCRIPT>" & vbNewLine
'			Response.Redirect "EmployeeSupport.asp?Action=Paperworks&New=1"
'			Response.Redirect "EmployeeSupport.asp?FilterStartNumber=" & aCatalogComponent(AS_FIELDS_VALUES_CATALOG)(1) & "&FilterEndNumber=" & aCatalogComponent(AS_FIELDS_VALUES_CATALOG)(1) & "&DoSearch=1"
		End If
		...
		If Not oRecordset.EOF Then
			...
			Response.Write """ CELLSPACING=""0"" CELLPADDING=""0"">" & vbNewLine
				If bUseLinks And Not bForExport Then
					...
					asCellWidths = Split("70,80,120,80,100,200,200,100,60", ",", -1, vbBinaryCompare)
				...
				Else
					...
					asCellWidths = Split("80,120,80,100,200,200,100,60", ",", -1, vbBinaryCompare)
...
Function GetOwnersCount(oRequest, oADODBConnection, lPaperID, sErrorDescription)
'************************************************************
'Purpose: To print the paperwork list
'Inputs:  oRequest, oADODBConnection, lListID
'Outputs: sErrorDescription
