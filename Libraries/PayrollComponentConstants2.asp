...
Call DisplayTimeStamp("START: LEVEL 3, PREPARE Payments, PaymentsMessages, PaymentsRecords, PaymentsRecords2 TABLE")
			If lErrorNumber = 0 Then
				...
				lErrorNumber = ExecuteSQLQuery(oADODBConnection, "Delete From PaymentsMessages Where (PayrollID=" & aPayrollComponent(N_ID_PAYROLL) & ")", "PayrollComponentConstants.asp", S_FUNCTION_NAME, 000, sErrorDescription, oRecordset)
			End If
