...
'************************************************************
	...
	Else
		...
		End If
		If lErrorNumber = 0 Then
			oFileSystem.CreateFolder(sFolderPath)
			lErrorNumber = Err.number
			If lErrorNumber <> 0 Then
...
Function CreateFolderPpwrk(sFolderPath, sErrorDescription)
'************************************************************
'Purpose: To create a new folder
'Inputs:  sFolderPath
'Outputs: sErrorDescription
'************************************************************
    On Error Resume Next
	Const S_FUNCTION_NAME = "CreateFolderPpwrk"
    Dim oFileSystem
    Dim sTempFolderPath
    Dim lErrorNumber
	...
	Set oFileSystem = Nothing
	CreateFolderPpwrk = lErrorNumber
	Err.Clear
End Function 'End of CreateFolder
