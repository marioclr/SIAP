				...
				Case "Paperworks"
					If lErrorNumber = 0 Then
						...
						If Len(oRequest("PaperworkNumber").Item) > 0 Then
							iPaperworkNumber = CLng(oRequest("PaperworkNumber").Item)
							If iPaperworkNumber < 150000 Then
								If InStr(1, "," & sOwnerIDs & ",", ",-1,", vbTextCompare) = 0 And InStr(1, "," & sOwnerIDs & ",", ",0,", vbTextCompare) = 0 Then
									lErrorNumber = -1
									sErrorDescription = "El usuario registrado NO puede asignar numeros de folio con numeración para Documentos Externos."
								End If
							End If
						End If
					End If
