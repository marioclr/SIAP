<%
Function GetAreasURLValues(oRequest, iSelectedTab, bAction, sCondition)
'************************************************************
...
'************************************************************
	...
	Const S_FUNCTION_NAME = "GetAreasURLValues"
	Dim oItem
	Dim aItem
	...
	GetAreasURLValues = Err.number
	Err.Clear
End Function

Function DoAreasAction(oRequest, oADODBConnection, sAction, sErrorDescription)
'************************************************************
...
'************************************************************
	On Error Resume Next
	Const S_FUNCTION_NAME = "DoAreasAction"
	Dim oRecordset
	Dim sNames
	Dim lErrorNumber
	...
	ElseIf Len(oRequest("Add").Item) > 0 Then
		Select Case sAction
			...
			Case Else
				lErrorNumber = AddArea(oRequest, oADODBConnection, aAreaComponent, sErrorDescription)
		End Select
	ElseIf Len(oRequest("Modify").Item) > 0 Then
		Select Case sAction
			...
			Case Else
				lErrorNumber = ModifyArea(oRequest, oADODBConnection, aAreaComponent, sErrorDescription)
		End Select
	ElseIf Len(oRequest("Remove").Item) > 0 Then
		...
		Select Case sAction
			...
			Case Else
				lErrorNumber = RemoveArea(oRequest, oADODBConnection, aAreaComponent, sErrorDescription)
				'If lErrorNumber = 0 Then
				'	If aAreaComponent(N_PARENT_ID_AREA) > -1 Then
				'		Response.Redirect "Areas.asp"
				'	Else
				'		Response.Redirect "Areas.asp?AreaID=" & aAreaComponent(N_PARENT_ID_AREA)
				'	End If
				'End If
		End Select
	ElseIf Len(oRequest("SetActive").Item) > 0 Then
		Select Case sAction
			...
			Case Else
				lErrorNumber = SetActiveForArea(oRequest, oADODBConnection, aAreaComponent, sErrorDescription)
		End Select
	End If

	Set oRecordset = Nothing
	DoAreasAction = lErrorNumber
	Err.Clear
End Function

Function DisplayAreasFilters(oRequest, sAction, sErrorDescription)
'************************************************************
...
'************************************************************
	On Error Resume Next
	Const S_FUNCTION_NAME = "DisplayAreasFilters"
	Dim bHasFilter
	Dim iIndex
	Dim lErrorNumber
	...
	DisplayAreasFilters = lErrorNumber
	Err.Clear
End Function

Function DisplayAreasSearchForm(oRequest, oADODBConnection, bFull, sErrorDescription)
'************************************************************
...
'************************************************************
	On Error Resume Next
	Const S_FUNCTION_NAME = "DisplayAreasSearchForm"
	...
	DisplayAreasSearchForm = Err.number
End Function

Function DisplayAreasTabs(oRequest, bError, sErrorDescription)
'************************************************************
...
'************************************************************
	On Error Resume Next
	Const S_FUNCTION_NAME = "DisplayAreasTabs"
	Dim sNames
	Dim asTitles
	Dim iIndex
	Dim sAction
