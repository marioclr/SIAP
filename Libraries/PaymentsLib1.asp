...
'************************************************************
	...
	If CLng(oRequest("PayrollID").Item) > 0 Then
		sCondition = sCondition & " And (EmployeesBlockPaymentsLKP.PayrollID=" & CStr(oRequest("PayrollID").Item) & ")"
	End If
		...
		If lErrorNumber = 0 Then
			Select Case sAction
				Case "PaymentsRecords"
					If CInt(aCatalogComponent(AS_FIELDS_VALUES_CATALOG)(4)) = -1 Then ' Entidad|ZoneIDs = Todas|No indicada
						sCondition = " And (EmployeesHistoryListForPayroll.CompanyID In (" & aCatalogComponent(AS_FIELDS_VALUES_CATALOG)(2) & ")) And (Areas1.AreaID In (" & aCatalogComponent(AS_FIELDS_VALUES_CATALOG)(3) & ")) And (EmployeesHistoryListForPayroll.EmployeeTypeID In (" & aCatalogComponent(AS_FIELDS_VALUES_CATALOG)(5) & ")) And (EmployeesHistoryListForPayroll.PayrollID=" & aCatalogComponent(AS_FIELDS_VALUES_CATALOG)(1) & ")"
					Else
						sCondition = " And (EmployeesHistoryListForPayroll.CompanyID In (" & aCatalogComponent(AS_FIELDS_VALUES_CATALOG)(2) & ")) And (Areas1.AreaID In (" & aCatalogComponent(AS_FIELDS_VALUES_CATALOG)(3) & ")) And (Zones1.ZoneID In (" & aCatalogComponent(AS_FIELDS_VALUES_CATALOG)(4) & ")) And (EmployeesHistoryListForPayroll.EmployeeTypeID In (" & aCatalogComponent(AS_FIELDS_VALUES_CATALOG)(5) & ")) And (EmployeesHistoryListForPayroll.PayrollID=" & aCatalogComponent(AS_FIELDS_VALUES_CATALOG)(1) & ")"
					End If
...
'************************************************************
	...
	Select Case aCatalogComponent(S_TABLE_NAME_CATALOG)
		Case "PaymentsRecords"
			If CInt(aCatalogComponent(AS_FIELDS_VALUES_CATALOG)(14)) = 2 Then
			...
			ElseIf CLng(aCatalogComponent(AS_FIELDS_VALUES_CATALOG)(8)) = -1 Then
				sCondition = " And (Payments.PaymentID>=" & aCatalogComponent(AS_FIELDS_VALUES_CATALOG)(12) & ") And (Payments.PaymentID<=" & aCatalogComponent(AS_FIELDS_VALUES_CATALOG)(13) & ")"
				If CLng(aCatalogComponent(AS_FIELDS_VALUES_CATALOG)(14)) <> 1 Then
			...
			Else
				sCondition = " And (Payments.PaymentID>=" & aCatalogComponent(AS_FIELDS_VALUES_CATALOG)(12) & ") And (Payments.PaymentID<=" & aCatalogComponent(AS_FIELDS_VALUES_CATALOG)(13) & ")"' And (BankAccounts.AccountNumber='.')"
				sErrorDescription = "No se pudieron obtener los empleados que cumplen con los criterios de la búsqueda."
		...
		Case "PaymentsRecords2"
			sCondition = "And (Payments.PaymentID=" & aCatalogComponent(AS_FIELDS_VALUES_CATALOG)(11) & ")"' And (BankAccounts.AccountNumber='.')"
			sErrorDescription = "No se pudieron obtener los empleados que cumplen con los criterios de la búsqueda."
			lErrorNumber = ExecuteSQLQuery(oADODBConnection, "Select EmployeeNumber, Companies.CompanyShortName, Companies.CompanyName, Areas1.AreaCode As AreaCode1, Areas1.AreaName As AreaName1, Areas2.AreaCode As AreaCode2, Areas2.AreaName As AreaName2, Zones1.ZoneName As ZoneName1, PaymentCenters.AreaCode As PaymentCenterCode, PaymentCenters.AreaName As PaymentCenterName, EmployeeTypes.EmployeeTypeShortName, EmployeeTypes.EmployeeTypeName, Payments.CheckNumber, Payments.CheckAmount, Replacements.CheckNumber As ReplacedNumber, StatusName From Payments, StatusPayments, Payments As Replacements, EmployeesHistoryListForPayroll, Companies, Areas As Areas1, Areas As Areas2, Areas As PaymentCenters, Zones As Zones1, Zones As Zones2, Zones As Zones3, EmployeeTypes, BankAccounts Where (Payments.StatusID=StatusPayments.StatusID) And (Payments.PaymentDate=Replacements.PaymentDate) And (Payments.CheckNumber=Replacements.ReplacementNumber) And (Payments.EmployeeID=EmployeesHistoryListForPayroll.EmployeeID) And (EmployeesHistoryListForPayroll.PayrollID=" & aCatalogComponent(AS_FIELDS_VALUES_CATALOG)(1) & ") And (PaymentCenters.CompanyID=Companies.CompanyID) And (EmployeesHistoryListForPayroll.PaymentCenterID=Areas2.AreaID) And (Areas2.ParentID=Areas1.AreaID) And (EmployeesHistoryListForPayroll.PaymentCenterID=PaymentCenters.AreaID) And (Areas2.ZoneID=Zones3.ZoneID) And (Zones3.ParentID=Zones2.ZoneID) And (Zones2.ParentID=Zones1.ZoneID) And (EmployeesHistoryListForPayroll.EmployeeTypeID=EmployeeTypes.EmployeeTypeID) And (EmployeesHistoryListForPayroll.EmployeeID=BankAccounts.EmployeeID) And (Companies.StartDate<=" & aCatalogComponent(AS_FIELDS_VALUES_CATALOG)(1) & ") And (Companies.EndDate>=" & aCatalogComponent(AS_FIELDS_VALUES_CATALOG)(1) & ") And (Areas1.StartDate<=" & aCatalogComponent(AS_FIELDS_VALUES_CATALOG)(1) & ") And (Areas1.EndDate>=" & aCatalogComponent(AS_FIELDS_VALUES_CATALOG)(1) & ") And (Areas2.StartDate<=" & aCatalogComponent(AS_FIELDS_VALUES_CATALOG)(1) & ") And (Areas2.EndDate>=" & aCatalogComponent(AS_FIELDS_VALUES_CATALOG)(1) & ") And (PaymentCenters.StartDate<=" & aCatalogComponent(AS_FIELDS_VALUES_CATALOG)(1) & ") And (PaymentCenters.EndDate>=" & aCatalogComponent(AS_FIELDS_VALUES_CATALOG)(1) & ") And (EmployeeTypes.StartDate<=" & aCatalogComponent(AS_FIELDS_VALUES_CATALOG)(1) & ") And (EmployeeTypes.EndDate>=" & aCatalogComponent(AS_FIELDS_VALUES_CATALOG)(1) & ") And (BankAccounts.StartDate<=" & aCatalogComponent(AS_FIELDS_VALUES_CATALOG)(1) & ") And (BankAccounts.EndDate>=" & aCatalogComponent(AS_FIELDS_VALUES_CATALOG)(1) & ") " & sCondition & " Order by Companies.CompanyShortName, Areas1.AreaCode, Areas2.AreaCode, EmployeeNumber", "PaymentsLib.asp", S_FUNCTION_NAME, 000, sErrorDescription, oRecordset)
			Response.Write vbNewLine & "<!-- Query: Select EmployeeNumber, Companies.CompanyShortName, Companies.CompanyName, Areas1.AreaCode As AreaCode1, Areas1.AreaName As AreaName1, Areas2.AreaCode As AreaCode2, Areas2.AreaName As AreaName2, Zones1.ZoneName As ZoneName1, PaymentCenters.AreaCode As PaymentCenterCode, PaymentCenters.AreaName As PaymentCenterName, EmployeeTypes.EmployeeTypeShortName, EmployeeTypes.EmployeeTypeName, Payments.CheckNumber, Payments.CheckAmount, Replacements.CheckNumber As ReplacedNumber, StatusName From Payments, StatusPayments, Payments As Replacements, EmployeesHistoryListForPayroll, Companies, Areas As Areas1, Areas As Areas2, Areas As PaymentCenters, Zones As Zones1, Zones As Zones2, Zones As Zones3, EmployeeTypes, BankAccounts Where (Payments.StatusID=StatusPayments.StatusID) And (Payments.PaymentDate=Replacements.PaymentDate) And (Payments.CheckNumber=Replacements.ReplacementNumber) And (Payments.EmployeeID=EmployeesHistoryListForPayroll.EmployeeID) And (EmployeesHistoryListForPayroll.PayrollID=" & aCatalogComponent(AS_FIELDS_VALUES_CATALOG)(1) & ") And (PaymentCenters.CompanyID=Companies.CompanyID) And (EmployeesHistoryListForPayroll.PaymentCenterID=Areas2.AreaID) And (Areas2.ParentID=Areas1.AreaID) And (EmployeesHistoryListForPayroll.PaymentCenterID=PaymentCenters.AreaID) And (Areas2.ZoneID=Zones3.ZoneID) And (Zones3.ParentID=Zones2.ZoneID) And (Zones2.ParentID=Zones1.ZoneID) And (EmployeesHistoryListForPayroll.EmployeeTypeID=EmployeeTypes.EmployeeTypeID) And (EmployeesHistoryListForPayroll.EmployeeID=BankAccounts.EmployeeID) And (Companies.StartDate<=" & aCatalogComponent(AS_FIELDS_VALUES_CATALOG)(1) & ") And (Companies.EndDate>=" & aCatalogComponent(AS_FIELDS_VALUES_CATALOG)(1) & ") And (Areas1.StartDate<=" & aCatalogComponent(AS_FIELDS_VALUES_CATALOG)(1) & ") And (Areas1.EndDate>=" & aCatalogComponent(AS_FIELDS_VALUES_CATALOG)(1) & ") And (Areas2.StartDate<=" & aCatalogComponent(AS_FIELDS_VALUES_CATALOG)(1) & ") And (Areas2.EndDate>=" & aCatalogComponent(AS_FIELDS_VALUES_CATALOG)(1) & ") And (PaymentCenters.StartDate<=" & aCatalogComponent(AS_FIELDS_VALUES_CATALOG)(1) & ") And (PaymentCenters.EndDate>=" & aCatalogComponent(AS_FIELDS_VALUES_CATALOG)(1) & ") And (EmployeeTypes.StartDate<=" & aCatalogComponent(AS_FIELDS_VALUES_CATALOG)(1) & ") And (EmployeeTypes.EndDate>=" & aCatalogComponent(AS_FIELDS_VALUES_CATALOG)(1) & ") And (BankAccounts.StartDate<=" & aCatalogComponent(AS_FIELDS_VALUES_CATALOG)(1) & ") And (BankAccounts.EndDate>=" & aCatalogComponent(AS_FIELDS_VALUES_CATALOG)(1) & ") " & sCondition & " Order by Companies.CompanyShortName, Areas1.AreaCode, Areas2.AreaCode, EmployeeNumber -->" & vbNewLine
		Case ""
		...
		If Not oRecordset.EOF Then
			...
			Response.Write """ CELLSPACING=""0"" CELLPADDING=""0"">" & vbNewLine
				...
				Do While Not oRecordset.EOF
					...
					If (Not bForExport) And (InStr(1, aLoginComponent(S_ACCESS_KEY_LOGIN), "vac", vbBinaryCompare) = 1) And (iRecordCounter >= ROWS_CATALOG) Then Exit Do
					If Err.number <> 0 Then Exit Do
				Loop
	...
	If lErrorNumber = 0 Then
		If Not oRecordset.EOF Then
			...
			Response.Write "<TABLE BORDER="""
				...
				End If
			Response.Write """ CELLSPACING=""0"" CELLPADDING=""0"">" & vbNewLine
				asColumnsTitles = Split("Fecha de nómina,Fecha de pago,Empleado,No. de cheque/depósito,Fecha de reexpedición,No. de reexpedición,Monto,Quincena de cancelación,Motivo de cancelación,Cancelación aplicada", ",", -1, vbBinaryCompare)
				asCellWidths = Split("100,100,100,100,100,100,100,100,100,100", ",", -1, vbBinaryCompare)
				If bForExport Then
					lErrorNumber = DisplayTableHeaderPlainText(asColumnsTitles, True, sErrorDescription)
				Else
	...
	If lErrorNumber = 0 Then
		...
		Response.Write "<SCRIPT LANGUAGE=""JavaScript""><!--" & vbNewLine
			Response.Write "var aPaymentsRecords = new Array("
				Call GenerateJavaScriptArrayFromQuery(oADODBConnection, "PaymentsRecords", "RecordID", "FirstNumber, LastNumber", "(RecordID>-1)" & sCondition, "RecordID", sErrorDescription)
			Response.Write "['-1', '-1', '-1']);" & vbNewLine
		...
		sErrorDescription = "No se pudieron obtener los registros de las asignaciones de folios para los pagos."
		lErrorNumber = ExecuteSQLQuery(oADODBConnection, "Select RecordID, PayrollID, CompanyIDs, AreaIDs, EmployeeTypeIDs, BankName, PaymentsRecords.EmployeeID, FirstNumber, LastNumber, ConceptID, bPrinted From PaymentsRecords, Banks Where (PaymentsRecords.BankID=Banks.BankID) " & sCondition & " Order By RecordID", "PaymentsLib.asp", S_FUNCTION_NAME, 000, sErrorDescription, oRecordset)
		Response.Write vbNewLine & "<!-- Query: Select RecordID, PayrollID, CompanyIDs, AreaIDs, EmployeeTypeIDs, BankName, PaymentsRecords.EmployeeID, FirstNumber, LastNumber, ConceptID, bPrinted From PaymentsRecords, Banks Where (PaymentsRecords.BankID=Banks.BankID) " & sCondition & " Order By RecordID -->" & vbNewLine
		If lErrorNumber = 0 Then
			If Not oRecordset.EOF Then
				bEmpty = False
				Response.Write "<TABLE WIDTH=""1100"" BORDER="""
					...
					End If
				Response.Write """ CELLSPACING=""0"" CELLPADDING=""0"">" & vbNewLine
					asColumnsTitles = Split("&nbsp;,Tipo,Fecha de pago,Compañía,Área,Tipo de tabulador,Banco,No. empleado,Primer número de folio,Último número de folio", ",", -1, vbBinaryCompare)
					asCellWidths = Split("100,100,100,100,200,100,100,100,100,100", ",", -1, vbBinaryCompare)
					If bForExport Then
						lErrorNumber = DisplayTableHeaderPlainText(asColumnsTitles, True, sErrorDescription)
					Else
						If CInt(GetOption(aOptionsComponent, TABLE_STYLE_OPTION)) = 2 Then
					...
					Do While Not oRecordset.EOF
						...
						If StrComp(aLoginComponent(N_PERMISSION_AREA_ID_LOGIN), "-1", vbBinaryCompare) <> 0 Then
							asAreaIDs = Split(Replace(CStr(oRecordset.Fields("AreaIDs").Value), " ", ""), ",")
...
'lErrorNumber = AppendTextToFile(sFilePath & ".txt", "Inicio de ejecución del query", sErrorDescription) 'TRACE
	...
	If lErrorNumber = 0 Then
		...
		Else
			...
			lErrorNumber = ExecuteSQLQuery(oADODBConnection, "Select PaymentID, Payments.PaymentDate, CheckAmount, Employees.EmployeeID, EmployeesHistoryListForPayroll.EmployeeNumber, EmployeeName, EmployeeLastName, EmployeeLastName2, RFC, CURP, SocialSecurityNumber, Employees.StartDate, EmployeesHistoryListForPayroll.CompanyID, EmployeesHistoryListForPayroll.EmployeeTypeID, Positions.PositionID, PositionShortName, PositionName, GroupGradeLevelShortName, LevelShortName, Areas1.AreaID As AreaID1, Areas2.AreaCode As AreaCode2, ZonePath, Payments.CheckNumber, EmployeesHistoryListForPayroll.AccountNumber As ToAccountNumber, Min(EmployeesChangesLKP.FirstDate) As MinDate, Max(EmployeesChangesLKP.LastDate) As MaxDate, Concepts.ConceptID, ConceptShortName, ConceptName, IsDeduction, Concepts.OrderInList, ConceptRetention, Sum(ConceptAmount) As TotalAmount From Payments, Payroll_" & aCatalogComponent(AS_FIELDS_VALUES_CATALOG)(1) & ", Concepts, EmployeesChangesLKP, EmployeesHistoryListForPayroll, Employees, Positions, GroupGradeLevels, Levels, Areas As Areas1, Areas As Areas2, Zones Where (Payments.EmployeeID=Payroll_" & aCatalogComponent(AS_FIELDS_VALUES_CATALOG)(1) & ".EmployeeID) And (Payroll_" & aCatalogComponent(AS_FIELDS_VALUES_CATALOG)(1) & ".ConceptID=Concepts.ConceptID) And (Payments.EmployeeID=EmployeesHistoryListForPayroll.EmployeeID) And (Payments.EmployeeID=EmployeesChangesLKP.EmployeeID) And (Payroll_" & aCatalogComponent(AS_FIELDS_VALUES_CATALOG)(1) & ".EmployeeID=EmployeesHistoryListForPayroll.EmployeeID) And (Payroll_" & aCatalogComponent(AS_FIELDS_VALUES_CATALOG)(1) & ".EmployeeID=EmployeesChangesLKP.EmployeeID) And (EmployeesChangesLKP.EmployeeID=EmployeesHistoryListForPayroll.EmployeeID) And (EmployeesHistoryListForPayroll.PayrollID=" & aCatalogComponent(AS_FIELDS_VALUES_CATALOG)(1) & ") And (EmployeesHistoryListForPayroll.EmployeeID=Employees.EmployeeID) And (EmployeesHistoryListForPayroll.PositionID=Positions.PositionID) And (EmployeesHistoryListForPayroll.GroupGradeLevelID=GroupGradeLevels.GroupGradeLevelID) And (EmployeesHistoryListForPayroll.LevelID=Levels.LevelID) And (EmployeesHistoryListForPayroll.PaymentCenterID=Areas2.AreaID) And (Areas2.ParentID=Areas1.AreaID) And (Areas2.ZoneID=Zones.ZoneID) And (Payments.PaymentDate=" & aCatalogComponent(AS_FIELDS_VALUES_CATALOG)(1) & ") And (Payroll_" & aCatalogComponent(AS_FIELDS_VALUES_CATALOG)(1) & ".RecordDate=EmployeesChangesLKP.PayrollDate) And (EmployeesChangesLKP.PayrollID=" & aCatalogComponent(AS_FIELDS_VALUES_CATALOG)(1) & ") And (Positions.StartDate<=" & aCatalogComponent(AS_FIELDS_VALUES_CATALOG)(1) & ") And (Positions.EndDate>=" & aCatalogComponent(AS_FIELDS_VALUES_CATALOG)(1) & ") And (GroupGradeLevels.StartDate<=" & aCatalogComponent(AS_FIELDS_VALUES_CATALOG)(1) & ") And (GroupGradeLevels.EndDate>=" & aCatalogComponent(AS_FIELDS_VALUES_CATALOG)(1) & ") And (Levels.StartDate<=" & aCatalogComponent(AS_FIELDS_VALUES_CATALOG)(1) & ") And (Levels.EndDate>=" & aCatalogComponent(AS_FIELDS_VALUES_CATALOG)(1) & ") And (Areas1.StartDate<=" & aCatalogComponent(AS_FIELDS_VALUES_CATALOG)(1) & ") And (Areas1.EndDate>=" & aCatalogComponent(AS_FIELDS_VALUES_CATALOG)(1) & ") And (Areas2.StartDate<=" & aCatalogComponent(AS_FIELDS_VALUES_CATALOG)(1) & ") And (Areas2.EndDate>=" & aCatalogComponent(AS_FIELDS_VALUES_CATALOG)(1) & ") And (Concepts.StartDate<=" & aCatalogComponent(AS_FIELDS_VALUES_CATALOG)(1) & ") And (Concepts.EndDate>=" & aCatalogComponent(AS_FIELDS_VALUES_CATALOG)(1) & ") " & sCondition & " Group By PaymentID, Payments.PaymentDate, CheckAmount, Employees.EmployeeID, EmployeesHistoryListForPayroll.EmployeeNumber, EmployeeName, EmployeeLastName, EmployeeLastName2, RFC, CURP, SocialSecurityNumber, Employees.StartDate, EmployeesHistoryListForPayroll.CompanyID, EmployeesHistoryListForPayroll.EmployeeTypeID, Positions.PositionID, PositionShortName, PositionName, GroupGradeLevelShortName, LevelShortName, Areas1.AreaID, Areas2.AreaCode, ZonePath, Payments.CheckNumber, EmployeesHistoryListForPayroll.AccountNumber, Concepts.ConceptID, ConceptShortName, ConceptName, IsDeduction, Concepts.OrderInList, ConceptRetention Order by PaymentID, IsDeduction, Concepts.OrderInList", "PaymentsLib.asp", S_FUNCTION_NAME, 000, sErrorDescription, oRecordset)
			Response.Write vbNewLine & "<!-- Query: Select PaymentID, Payments.PaymentDate, CheckAmount, Employees.EmployeeID, EmployeesHistoryListForPayroll.EmployeeNumber, EmployeeName, EmployeeLastName, EmployeeLastName2, RFC, CURP, SocialSecurityNumber, Employees.StartDate, EmployeesHistoryListForPayroll.CompanyID, EmployeesHistoryListForPayroll.EmployeeTypeID, Positions.PositionID, PositionShortName, PositionName, GroupGradeLevelShortName, LevelShortName, Areas1.AreaID As AreaID1, Areas2.AreaCode As AreaCode2, ZonePath, Payments.CheckNumber, EmployeesHistoryListForPayroll.AccountNumber As ToAccountNumber, Min(EmployeesChangesLKP.FirstDate) As MinDate, Max(EmployeesChangesLKP.LastDate) As MaxDate, Concepts.ConceptID, ConceptShortName, ConceptName, IsDeduction, Concepts.OrderInList, ConceptRetention, Sum(ConceptAmount) As TotalAmount From Payments, Payroll_" & aCatalogComponent(AS_FIELDS_VALUES_CATALOG)(1) & ", Concepts, EmployeesChangesLKP, EmployeesHistoryListForPayroll, Employees, Positions, GroupGradeLevels, Levels, Areas As Areas1, Areas As Areas2, Zones Where (Payments.EmployeeID=Payroll_" & aCatalogComponent(AS_FIELDS_VALUES_CATALOG)(1) & ".EmployeeID) And (Payroll_" & aCatalogComponent(AS_FIELDS_VALUES_CATALOG)(1) & ".ConceptID=Concepts.ConceptID) And (Payments.EmployeeID=EmployeesHistoryListForPayroll.EmployeeID) And (Payments.EmployeeID=EmployeesChangesLKP.EmployeeID) And (Payroll_" & aCatalogComponent(AS_FIELDS_VALUES_CATALOG)(1) & ".EmployeeID=EmployeesHistoryListForPayroll.EmployeeID) And (Payroll_" & aCatalogComponent(AS_FIELDS_VALUES_CATALOG)(1) & ".EmployeeID=EmployeesChangesLKP.EmployeeID) And (EmployeesChangesLKP.EmployeeID=EmployeesHistoryListForPayroll.EmployeeID) And (EmployeesHistoryListForPayroll.PayrollID=" & aCatalogComponent(AS_FIELDS_VALUES_CATALOG)(1) & ") And (EmployeesHistoryListForPayroll.EmployeeID=Employees.EmployeeID) And (EmployeesHistoryListForPayroll.PositionID=Positions.PositionID) And (EmployeesHistoryListForPayroll.GroupGradeLevelID=GroupGradeLevels.GroupGradeLevelID) And (EmployeesHistoryListForPayroll.LevelID=Levels.LevelID) And (EmployeesHistoryListForPayroll.PaymentCenterID=Areas2.AreaID) And (Areas2.ParentID=Areas1.AreaID) And (Areas2.ZoneID=Zones.ZoneID) And (Payments.PaymentDate=" & aCatalogComponent(AS_FIELDS_VALUES_CATALOG)(1) & ") And (Payroll_" & aCatalogComponent(AS_FIELDS_VALUES_CATALOG)(1) & ".RecordDate=EmployeesChangesLKP.PayrollDate) And (EmployeesChangesLKP.PayrollID=" & aCatalogComponent(AS_FIELDS_VALUES_CATALOG)(1) & ") And (Positions.StartDate<=" & aCatalogComponent(AS_FIELDS_VALUES_CATALOG)(1) & ") And (Positions.EndDate>=" & aCatalogComponent(AS_FIELDS_VALUES_CATALOG)(1) & ") And (GroupGradeLevels.StartDate<=" & aCatalogComponent(AS_FIELDS_VALUES_CATALOG)(1) & ") And (GroupGradeLevels.EndDate>=" & aCatalogComponent(AS_FIELDS_VALUES_CATALOG)(1) & ") And (Levels.StartDate<=" & aCatalogComponent(AS_FIELDS_VALUES_CATALOG)(1) & ") And (Levels.EndDate>=" & aCatalogComponent(AS_FIELDS_VALUES_CATALOG)(1) & ") And (Areas1.StartDate<=" & aCatalogComponent(AS_FIELDS_VALUES_CATALOG)(1) & ") And (Areas1.EndDate>=" & aCatalogComponent(AS_FIELDS_VALUES_CATALOG)(1) & ") And (Areas2.StartDate<=" & aCatalogComponent(AS_FIELDS_VALUES_CATALOG)(1) & ") And (Areas2.EndDate>=" & aCatalogComponent(AS_FIELDS_VALUES_CATALOG)(1) & ") And (Concepts.StartDate<=" & aCatalogComponent(AS_FIELDS_VALUES_CATALOG)(1) & ") And (Concepts.EndDate>=" & aCatalogComponent(AS_FIELDS_VALUES_CATALOG)(1) & ") " & sCondition & " Group By PaymentID, Payments.PaymentDate, CheckAmount, Employees.EmployeeID, EmployeesHistoryListForPayroll.EmployeeNumber, EmployeeName, EmployeeLastName, EmployeeLastName2, RFC, CURP, SocialSecurityNumber, Employees.StartDate, EmployeesHistoryListForPayroll.CompanyID, EmployeesHistoryListForPayroll.EmployeeTypeID, Positions.PositionID, PositionShortName, PositionName, GroupGradeLevelShortName, LevelShortName, Areas1.AreaID, Areas2.AreaCode, ZonePath, Payments.CheckNumber, EmployeesHistoryListForPayroll.AccountNumber, Concepts.ConceptID, ConceptShortName, ConceptName, IsDeduction, Concepts.OrderInList, ConceptRetention Order by PaymentID, IsDeduction, Concepts.OrderInList -->" & vbNewLine
		End If
	End If
...
'lErrorNumber = AppendTextToFile(sFilePath & ".txt", (sCurrentNumber & vbTab & lFileCounter), sErrorDescription) 'TRACE
							...
							End If
							lErrorNumber = AppendTextToFile(Replace(sDocumentName, "<INDEX />", lFileCounter), "{\pard \pvpg\phpg \posx" & CInt(800 + x1PositionDisplacement) & "\posy" & CInt(600 + l01PositionDisplacement + y1PositionDisplacement) & " \absw1247{\*\atnid NO.EMP.}", sErrorDescription)
							...
							lErrorNumber = AppendTextToFile(Replace(sDocumentName, "<INDEX />", lFileCounter), "{\pard \pvpg\phpg \posx" & CInt(2200 + x1PositionDisplacement) & "\posy" & CInt(600 + l01PositionDisplacement + y1PositionDisplacement) & " \absw8000{\*\atnid NOMBRE}", sErrorDescription)
							...
							End If
							lErrorNumber = AppendTextToFile(Replace(sDocumentName, "<INDEX />", lFileCounter), "\par}", sErrorDescription)
							lErrorNumber = AppendTextToFile(Replace(sDocumentName, "<INDEX />", lFileCounter), "{\pard \pvpg\phpg \posx" & CInt(8800 + x1PositionDisplacement) & "\posy" & CInt(600 + l01PositionDisplacement + y1PositionDisplacement) & " \absw2500{\*\atnid NO.CHEQUE}", sErrorDescription)
							'lErrorNumber = AppendTextToFile(Replace(sDocumentName, "<INDEX />", lFileCounter), "\fs12 \b", sErrorDescription)
							...
							If StrComp(oRecordset.Fields("ToAccountNumber").Value, ".", vbBinaryCompare) = 0 Then
								lErrorNumber = AppendTextToFile(Replace(sDocumentName, "<INDEX />", lFileCounter), "{\pard \pvpg\phpg \posx" & CInt(8300 + x2PositionDisplacement) & "\posy" & CInt(12000 + y2PositionDisplacement) & " \absw2500{\*\atnid NO.CHEQUE}", sErrorDescription)
								lErrorNumber = AppendTextToFile(Replace(sDocumentName, "<INDEX />", lFileCounter), CleanStringForHTML(SizeText(CStr(oRecordset.Fields("CheckNumber").Value), "0", 10, 0)), sErrorDescription)
								lErrorNumber = AppendTextToFile(Replace(sDocumentName, "<INDEX />", lFileCounter), "\par}", sErrorDescription)
							End If
							lErrorNumber = AppendTextToFile(Replace(sDocumentName, "<INDEX />", lFileCounter), "{\pard \pvpg\phpg \posx" & CInt(800 + x1PositionDisplacement) & "\posy" & CInt(1100 + l02PositionDisplacement + y1PositionDisplacement) & " \absw2240{\*\atnid RFC}", sErrorDescription)
							...
							lErrorNumber = AppendTextToFile(Replace(sDocumentName, "<INDEX />", lFileCounter), "\par}", sErrorDescription)
							lErrorNumber = AppendTextToFile(Replace(sDocumentName, "<INDEX />", lFileCounter), "{\pard \pvpg\phpg \posx" & CInt(4000 + x1PositionDisplacement) & "\posy" & CInt(1100 + l02PositionDisplacement + y1PositionDisplacement) & " \absw5075{\*\atnid CURP}", sErrorDescription)
							...
							lErrorNumber = AppendTextToFile(Replace(sDocumentName, "<INDEX />", lFileCounter), "\par}", sErrorDescription)
							If StrComp(oRecordset.Fields("ToAccountNumber").Value, ".", vbBinaryCompare) = 0 Then
								lErrorNumber = AppendTextToFile(Replace(sDocumentName, "<INDEX />", lFileCounter), "{\pard \pvpg\phpg \posx" & CInt(9000 + x1PositionDisplacement) & "\posy" & CInt(1100 + l02PositionDisplacement + y1PositionDisplacement) & " \absw3856{\*\atnid NSS}", sErrorDescription)
								...
								lErrorNumber = AppendTextToFile(Replace(sDocumentName, "<INDEX />", lFileCounter), "\par}", sErrorDescription)
							Else
								lErrorNumber = AppendTextToFile(Replace(sDocumentName, "<INDEX />", lFileCounter), "{\pard \pvpg\phpg \posx" & CInt(7740 + x1PositionDisplacement) & "\posy" & CInt(1100 + l02PositionDisplacement + y1PositionDisplacement) + l01PositionDisplacement & " \absw3856{\*\atnid NSS}", sErrorDescription)
								lErrorNumber = AppendTextToFile(Replace(sDocumentName, "<INDEX />", lFileCounter), CleanStringForHTML(CStr(oRecordset.Fields("SocialSecurityNumber").Value)), sErrorDescription)
								lErrorNumber = AppendTextToFile(Replace(sDocumentName, "<INDEX />", lFileCounter), "\par}", sErrorDescription)
							End If
							If StrComp(oRecordset.Fields("ToAccountNumber").Value, ".", vbBinaryCompare) = 0 Then ' CLAVE PUESTO
								lErrorNumber = AppendTextToFile(Replace(sDocumentName, "<INDEX />", lFileCounter), "{\pard \pvpg\phpg \posx" & CInt(800 + x1PositionDisplacement) & "\posy" & CInt(1550 + l03PositionDisplacement + y1PositionDisplacement) & " \absw2240{\*\atnid CLAVE_PUESTO}", sErrorDescription)
							Else
								lErrorNumber = AppendTextToFile(Replace(sDocumentName, "<INDEX />", lFileCounter), "{\pard \pvpg\phpg \posx" & CInt(800 + x1PositionDisplacement) & "\posy" & CInt(1650 + l03PositionDisplacementR + y1PositionDisplacement) & " \absw2240{\*\atnid CLAVE_PUESTO}", sErrorDescription)
							End If
							...
							If StrComp(oRecordset.Fields("ToAccountNumber").Value, ".", vbBinaryCompare) = 0 Then ' DESC_PUESTO
								lErrorNumber = AppendTextToFile(Replace(sDocumentName, "<INDEX />", lFileCounter), "{\pard \pvpg\phpg \posx" & CInt(2900 + x1PositionDisplacement) & "\posy" & CInt(1550 + l03PositionDisplacement + y1PositionDisplacement) & " \absw3515{\*\atnid DESC_PUESTO}", sErrorDescription)
							Else
								lErrorNumber = AppendTextToFile(Replace(sDocumentName, "<INDEX />", lFileCounter), "{\pard \pvpg\phpg \posx" & CInt(2300 + x1PositionDisplacement) & "\posy" & CInt(1650 + l03PositionDisplacementR + y1PositionDisplacement) & " \absw4115{\*\atnid DESC_PUESTO}", sErrorDescription)
							...
							If StrComp(oRecordset.Fields("ToAccountNumber").Value, ".", vbBinaryCompare) = 0 Then ' NIV_SUB
								lErrorNumber = AppendTextToFile(Replace(sDocumentName, "<INDEX />", lFileCounter), "{\pard \pvpg\phpg \posx" & CInt(6300 + x1PositionDisplacement) & "\posy" & CInt(1550 + l03PositionDisplacement + y1PositionDisplacement) & " \absw737{\*\atnid NIV_SUB}", sErrorDescription)
							Else
								lErrorNumber = AppendTextToFile(Replace(sDocumentName, "<INDEX />", lFileCounter), "{\pard \pvpg\phpg \posx" & CInt(6400 + x1PositionDisplacement) & "\posy" & CInt(1650 + l03PositionDisplacementR + y1PositionDisplacement) & " \absw637{\*\atnid NIV_SUB}", sErrorDescription)
							End If
							...
							If StrComp(oRecordset.Fields("ToAccountNumber").Value, ".", vbBinaryCompare) = 0 Then ' RG_MX
								lErrorNumber = AppendTextToFile(Replace(sDocumentName, "<INDEX />", lFileCounter), "{\pard \pvpg\phpg \posx" & CInt(7200 + x1PositionDisplacement) & "\posy" & CInt(1550 + l03PositionDisplacement + y1PositionDisplacement) & " \absw567{\*\atnid RG_MX}", sErrorDescription)
							Else
								lErrorNumber = AppendTextToFile(Replace(sDocumentName, "<INDEX />", lFileCounter), "{\pard \pvpg\phpg \posx" & CInt(7200 + x1PositionDisplacement) & "\posy" & CInt(1650 + l03PositionDisplacementR + y1PositionDisplacement) & " \absw567{\*\atnid RG_MX}", sErrorDescription)
							End If
							...
							If StrComp(oRecordset.Fields("ToAccountNumber").Value, ".", vbBinaryCompare) = 0 Then ' CG_RP
								lErrorNumber = AppendTextToFile(Replace(sDocumentName, "<INDEX />", lFileCounter), "{\pard \pvpg\phpg \posx" & CInt(7800 + x1PositionDisplacement) & "\posy" & CInt(1550 + l03PositionDisplacement + y1PositionDisplacement) & " \absw567{\*\atnid CG_RP}", sErrorDescription)
							Else
								lErrorNumber = AppendTextToFile(Replace(sDocumentName, "<INDEX />", lFileCounter), "{\pard \pvpg\phpg \posx" & CInt(7800 + x1PositionDisplacement) & "\posy" & CInt(1650 + l03PositionDisplacementR + y1PositionDisplacement) & " \absw567{\*\atnid CG_RP}", sErrorDescription)
							End If
							...
							If StrComp(oRecordset.Fields("ToAccountNumber").Value, ".", vbBinaryCompare) = 0 Then ' CLAVE_PRESUPUESTAL
								lErrorNumber = AppendTextToFile(Replace(sDocumentName, "<INDEX />", lFileCounter), "{\pard \pvpg\phpg \posx" & CInt(8600 + x1PositionDisplacement) & "\posy" & CInt(1550 + l03PositionDisplacement + y1PositionDisplacement) & " \absw1500{\*\atnid CLAVE_PRESUPUESTAL}", sErrorDescription)
							Else
								lErrorNumber = AppendTextToFile(Replace(sDocumentName, "<INDEX />", lFileCounter), "{\pard \pvpg\phpg \posx" & CInt(8600 + x1PositionDisplacement) & "\posy" & CInt(1650 + l03PositionDisplacementR + y1PositionDisplacement) & " \absw1500{\*\atnid CLAVE_PRESUPUESTAL}", sErrorDescription)
							End If
							...
							If StrComp(oRecordset.Fields("ToAccountNumber").Value, ".", vbBinaryCompare) = 0 Then ' CLAVE_DISTRIBUCION
								lErrorNumber = AppendTextToFile(Replace(sDocumentName, "<INDEX />", lFileCounter), "{\pard \pvpg\phpg \posx" & CInt(10400 + x1PositionDisplacement) & "\posy" & CInt(1550 + l03PositionDisplacement + y1PositionDisplacement) & " \absw1500{\*\atnid CLAVE_DISTRIBUCION}", sErrorDescription)
							Else
								lErrorNumber = AppendTextToFile(Replace(sDocumentName, "<INDEX />", lFileCounter), "{\pard \pvpg\phpg \posx" & CInt(10400 + x1PositionDisplacement) & "\posy" & CInt(1650 + l03PositionDisplacementR + y1PositionDisplacement) & " \absw1500{\*\atnid CLAVE_DISTRIBUCION}", sErrorDescription)
							End If
							lErrorNumber = AppendTextToFile(Replace(sDocumentName, "<INDEX />", lFileCounter), CleanStringForHTML(CStr(oRecordset.Fields("AreaCode2").Value)), sErrorDescription)
							lErrorNumber = AppendTextToFile(Replace(sDocumentName, "<INDEX />", lFileCounter), "\par}", sErrorDescription)
							If StrComp(oRecordset.Fields("ToAccountNumber").Value, ".", vbBinaryCompare) = 0 Then ' FECHA_INGRESO
								lErrorNumber = AppendTextToFile(Replace(sDocumentName, "<INDEX />", lFileCounter), "{\pard \pvpg\phpg \posx" & CInt(800 + x1PositionDisplacement) & "\posy" & CInt(2000 + l04PositionDisplacement + y1PositionDisplacement) & " \absw1956{\*\atnid FECHA_INGRESO}", sErrorDescription)
							Else
								lErrorNumber = AppendTextToFile(Replace(sDocumentName, "<INDEX />", lFileCounter), "{\pard \pvpg\phpg \posx" & CInt(800 + x1PositionDisplacement) & "\posy" & CInt(2150 + l04PositionDisplacementR + y1PositionDisplacement) & " \absw1956{\*\atnid FECHA_INGRESO}", sErrorDescription)
							End If
							...
							If StrComp(oRecordset.Fields("ToAccountNumber").Value, ".", vbBinaryCompare) = 0 Then ' FECHA_NOMINA
								lErrorNumber = AppendTextToFile(Replace(sDocumentName, "<INDEX />", lFileCounter), "{\pard \pvpg\phpg \posx" & CInt(2900 + x1PositionDisplacement) & "\posy" & CInt(2000 + l04PositionDisplacement + y1PositionDisplacement) & " \absw2256{\*\atnid FECHA_NOMINA}", sErrorDescription)
							Else
								lErrorNumber = AppendTextToFile(Replace(sDocumentName, "<INDEX />", lFileCounter), "{\pard \pvpg\phpg \posx" & CInt(2900 + x1PositionDisplacement) & "\posy" & CInt(2150 + l04PositionDisplacementR + y1PositionDisplacement) & " \absw2256{\*\atnid FECHA_NOMINA}", sErrorDescription)
							End If
							...
							If StrComp(oRecordset.Fields("ToAccountNumber").Value, ".", vbBinaryCompare) = 0 Then ' PERIODO_PAGO
								lErrorNumber = AppendTextToFile(Replace(sDocumentName, "<INDEX />", lFileCounter), "{\pard \pvpg\phpg \posx" & CInt(4500 + x1PositionDisplacement) & "\posy" & CInt(2000 + l04PositionDisplacement + y1PositionDisplacement) & " \absw3742{\*\atnid PERIODO_PAGO}", sErrorDescription)
							Else
								lErrorNumber = AppendTextToFile(Replace(sDocumentName, "<INDEX />", lFileCounter), "{\pard \pvpg\phpg \posx" & CInt(4500 + x1PositionDisplacement) & "\posy" & CInt(2150 + l04PositionDisplacementR + y1PositionDisplacement) & " \absw3742{\*\atnid PERIODO_PAGO}", sErrorDescription)
							End If
							If lMinDate = 0 Then lMinDate = lPayrollID
							If lMaxDate = 0 Then lMaxDate = lPayrollID
							...
							If StrComp(oRecordset.Fields("ToAccountNumber").Value, ".", vbBinaryCompare) = 0 Then ' NETO_A_PAGAR
								lErrorNumber = AppendTextToFile(Replace(sDocumentName, "<INDEX />", lFileCounter), "{\pard \pvpg\phpg \posx" & CInt(10200 + x1PositionDisplacement) & "\posy" & CInt(2000 + l04PositionDisplacement + y1PositionDisplacement) & " \absw1400{\*\atnid NETO_A_PAGAR}", sErrorDescription)
							Else
								lErrorNumber = AppendTextToFile(Replace(sDocumentName, "<INDEX />", lFileCounter), "{\pard \pvpg\phpg \posx" & CInt(10400 + x1PositionDisplacement) & "\posy" & CInt(2150 + l04PositionDisplacementR + y1PositionDisplacement) & " \absw1400{\*\atnid NETO_A_PAGAR}", sErrorDescription)
							End If
							...
							lErrorNumber = AppendTextToFile(Replace(sDocumentName, "<INDEX />", lFileCounter), "\par}", sErrorDescription)
							If StrComp(oRecordset.Fields("ToAccountNumber").Value, ".", vbBinaryCompare) = 0 Then
								lErrorNumber = AppendTextToFile(Replace(sDocumentName, "<INDEX />", lFileCounter), "{\pard \pvpg\phpg \posx" & CInt(7100 + x2PositionDisplacement) & "\posy" & CInt(12300 + y2PositionDisplacement) & " \absw2156{\*\atnid FECHA_NOMINA}", sErrorDescription)
								...
								lErrorNumber = AppendTextToFile(Replace(sDocumentName, "<INDEX />", lFileCounter), "\par}", sErrorDescription)
								lErrorNumber = AppendTextToFile(Replace(sDocumentName, "<INDEX />", lFileCounter), "{\pard \pvpg\phpg \posx" & CInt(10200 + x2PositionDisplacement) & "\posy" & CInt(13150 + y2PositionDisplacement) & " \absw2000{\*\atnid MONEDA_NACIONAL}", sErrorDescription)
								...
								lErrorNumber = AppendTextToFile(Replace(sDocumentName, "<INDEX />", lFileCounter), "\par}", sErrorDescription)
								lErrorNumber = AppendTextToFile(Replace(sDocumentName, "<INDEX />", lFileCounter), "{\pard \pvpg\phpg \posx" & CInt(2212 + x2PositionDisplacement) & "\posy" & CInt(13100 + y2PositionDisplacement) & " \absw8500{\*\atnid NOMBRE_CHEQUE}", sErrorDescription)
								...
								End If
								lErrorNumber = AppendTextToFile(Replace(sDocumentName, "<INDEX />", lFileCounter), "\par}", sErrorDescription)
								lErrorNumber = AppendTextToFile(Replace(sDocumentName, "<INDEX />", lFileCounter), "{\pard \pvpg\phpg \posx" & CInt(1200 + x2PositionDisplacement) & "\posy" & CInt(13550 + y2PositionDisplacement) & " \absw7950{\*\atnid MONEDA_NACIONAL_TEXTO}", sErrorDescription)
...
'								lErrorNumber = AppendTextToFile(Replace(sDocumentName, "<INDEX />", lFileCounter), "\par}", sErrorDescription)
							...
							If StrComp(oRecordset.Fields("ToAccountNumber").Value, ".", vbBinaryCompare) = 0 Then
								...
								Else
									...
									End If
								End If
								lErrorNumber = AppendTextToFile(Replace(sDocumentName, "<INDEX />", lFileCounter), "{\pard \pvpg\phpg \posx" & CInt(6379 + x2PositionDisplacement) & "\posy" & CInt(14150 + lSignaturesPositionDisplacementR + y2PositionDisplacement) & " \absw2778{\*\atnid FIRMA1}", sErrorDescription)
								lErrorNumber = AppendTextToFile(Replace(sDocumentName, "<INDEX />", lFileCounter), "{\field\fldedit{\*\fldinst { INCLUDEPICTURE \\d", sErrorDescription)
								lErrorNumber = AppendTextToFile(Replace(sDocumentName, "<INDEX />", lFileCounter), "\~"&sSignatureName1, sErrorDescription)
								lErrorNumber = AppendTextToFile(Replace(sDocumentName, "<INDEX />", lFileCounter), "\\* MERGEFORMATINET }}{\fldrslt { }}}", sErrorDescription)
								lErrorNumber = AppendTextToFile(Replace(sDocumentName, "<INDEX />", lFileCounter), "\par}", sErrorDescription)
								lErrorNumber = AppendTextToFile(Replace(sDocumentName, "<INDEX />", lFileCounter), "{\pard \pvpg\phpg \posx" & CInt(8959 + x2PositionDisplacement) & "\posy" & CInt(14150 + lSignaturesPositionDisplacementR + y2PositionDisplacement) & " \absw2778{\*\atnid FIRMA2}", sErrorDescription)
								lErrorNumber = AppendTextToFile(Replace(sDocumentName, "<INDEX />", lFileCounter), "{\field\fldedit{\*\fldinst { INCLUDEPICTURE \\d", sErrorDescription)
							...
							For iIndex = 0 To UBound(asMessages) - 1
								If ((StrComp(asMessages(iIndex)(1), ",0,", vbBinaryCompare) = 0) Or (InStr(1, asMessages(iIndex)(1), "," & CStr(oRecordset.Fields("EmployeeID").Value) & ",", vbBinaryCompare) > 0)) And _
								   ...
								   ((StrComp(asMessages(iIndex)(6), ",-1,", vbBinaryCompare) = 0) Or (InStr(1, asMessages(iIndex)(6), "," & CStr(oRecordset.Fields("PositionID").Value) & ",", vbBinaryCompare) > 0)) And _
						...
						Select Case CStr(oRecordset.Fields("ConceptShortName").Value)
							Case "D"
								...
								If StrComp(oRecordset.Fields("ToAccountNumber").Value, ".", vbBinaryCompare) = 0 Then ' TOTAL_DEDUCCIONES
									lErrorNumber = AppendTextToFile(Replace(sDocumentName, "<INDEX />", lFileCounter), "{\pard \pvpg\phpg \posx" & CInt(10524 + x1PositionDisplacement) & "\posy" & CInt(6650 + lConceptsTPositionDisplacement + y1PositionDisplacement) & " \absw1500{\*\atnid TOTAL_DEDUCCIONES}", sErrorDescription)
								Else
									lErrorNumber = AppendTextToFile(Replace(sDocumentName, "<INDEX />", lFileCounter), "{\pard \pvpg\phpg \posx" & CInt(10624 + x1PositionDisplacement) & "\posy" & CInt(7200 + lConceptsTPositionDisplacementR + y1PositionDisplacement) & " \absw1500{\*\atnid TOTAL_DEDUCCIONES}", sErrorDescription)
								End If
							...
							Case "P"
								...
								If StrComp(oRecordset.Fields("ToAccountNumber").Value, ".", vbBinaryCompare) = 0 Then ' TOTAL_PERCEPCIONES
									lErrorNumber = AppendTextToFile(Replace(sDocumentName, "<INDEX />", lFileCounter), "{\pard \pvpg\phpg \posx" & CInt(4824 + x1PositionDisplacement) & "\posy" & CInt(6650 + lConceptsTPositionDisplacement + y1PositionDisplacement) & " \absw1500{\*\atnid TOTAL_PERCEPCIONES}", sErrorDescription)
								Else
									lErrorNumber = AppendTextToFile(Replace(sDocumentName, "<INDEX />", lFileCounter), "{\pard \pvpg\phpg \posx" & CInt(4924 + x1PositionDisplacement) & "\posy" & CInt(7200 + lConceptsTPositionDisplacementR + y1PositionDisplacement) & " \absw1500{\*\atnid TOTAL_PERCEPCIONES}", sErrorDescription)
								End If
								...
								If StrComp(oRecordset.Fields("ToAccountNumber").Value, ".", vbBinaryCompare) = 0 Then ' BASE_GRAVABLE
									lErrorNumber = AppendTextToFile(Replace(sDocumentName, "<INDEX />", lFileCounter), "{\pard \pvpg\phpg \posx" & CInt(8400 + x1PositionDisplacement) & "\posy" & CInt(2000 + l04PositionDisplacement + y1PositionDisplacement) & " \absw1400{\*\atnid BASE_GRAVABLE}", sErrorDescription)
								Else
									lErrorNumber = AppendTextToFile(Replace(sDocumentName, "<INDEX />", lFileCounter), "{\pard \pvpg\phpg \posx" & CInt(8600 + x1PositionDisplacement) & "\posy" & CInt(2150 + l04PositionDisplacementR + y1PositionDisplacement) & " \absw1400{\*\atnid BASE_GRAVABLE}", sErrorDescription)
								End If
								lErrorNumber = AppendTextToFile(Replace(sDocumentName, "<INDEX />", lFileCounter), FormatNumber(lPerceptions, 2, True, False, True), sErrorDescription)
								lErrorNumber = AppendTextToFile(Replace(sDocumentName, "<INDEX />", lFileCounter), "\par}", sErrorDescription)
							Case "L"
							...
							Case Else
								If CInt(oRecordset.Fields("IsDeduction").Value) = 0 Then
									lConceptAmount = CDbl(oRecordset.Fields("TotalAmount").Value)
									'asConceptsP = asConceptsP & "P " & SECOND_LIST_SEPARATOR & CStr(oRecordset.Fields("ConceptShortName").Value) & SECOND_LIST_SEPARATOR & CStr(oRecordset.Fields("ConceptAmount").Value) & SECOND_LIST_SEPARATOR & CStr(oRecordset.Fields("RecordDate").Value) & LIST_SEPARATOR
									If StrComp(oRecordset.Fields("ToAccountNumber").Value, ".", vbBinaryCompare) = 0 Then ' CONCEPTO1
										lErrorNumber = AppendTextToFile(Replace(sDocumentName, "<INDEX />", lFileCounter), "{\pard \pvpg\phpg \posx" & CInt(700 + x1PositionDisplacement) & "\posy" & CInt(yPositionForConceptsP + lConceptsPositionDisplacement + y1PositionDisplacement) & " \absw737{\*\atnid CAVE.CPTO.} {\*\atnid CONCEPTO1}", sErrorDescription)
									Else
										lErrorNumber = AppendTextToFile(Replace(sDocumentName, "<INDEX />", lFileCounter), "{\pard \pvpg\phpg \posx" & CInt(700 + x1PositionDisplacement) & "\posy" & CInt(yPositionForConceptsP + 200 + lConceptsPositionDisplacementR + y1PositionDisplacement) & " \absw737{\*\atnid CAVE.CPTO.} {\*\atnid CONCEPTO1}", sErrorDescription)
									End If
									lErrorNumber = AppendTextToFile(Replace(sDocumentName, "<INDEX />", lFileCounter), "\fs14", sErrorDescription)
									...
									If StrComp(oRecordset.Fields("ToAccountNumber").Value, ".", vbBinaryCompare) = 0 Then ' DESCRIPCION
										lErrorNumber = AppendTextToFile(Replace(sDocumentName, "<INDEX />", lFileCounter), "{\pard \pvpg\phpg \posx" & CInt(1300 + x1PositionDisplacement) & "\posy" & CInt(yPositionForConceptsP + lConceptsPositionDisplacement + y1PositionDisplacement) & " \absw3515{\*\atnid DESCRIPCION}", sErrorDescription)
									Else
										lErrorNumber = AppendTextToFile(Replace(sDocumentName, "<INDEX />", lFileCounter), "{\pard \pvpg\phpg \posx" & CInt(1300 + x1PositionDisplacement) & "\posy" & CInt(yPositionForConceptsP + 200 + lConceptsPositionDisplacementR + y1PositionDisplacement) & " \absw3515{\*\atnid DESCRIPCION}", sErrorDescription)
									End If
									lErrorNumber = AppendTextToFile(Replace(sDocumentName, "<INDEX />", lFileCounter), "\fs14", sErrorDescription)
									...
									If StrComp(oRecordset.Fields("ToAccountNumber").Value, ".", vbBinaryCompare) = 0 Then ' IMPORTE
										lErrorNumber = AppendTextToFile(Replace(sDocumentName, "<INDEX />", lFileCounter), "{\pard \pvpg\phpg \posx" & CInt(4924 + x1PositionDisplacement) & "\posy" & CInt(yPositionForConceptsP + lConceptsPositionDisplacement + y1PositionDisplacement) & " \absw1214{\*\atnid IMPORTE}", sErrorDescription)
									Else
										lErrorNumber = AppendTextToFile(Replace(sDocumentName, "<INDEX />", lFileCounter), "{\pard \pvpg\phpg \posx" & CInt(4924 + x1PositionDisplacement) & "\posy" & CInt(yPositionForConceptsP + 200 + lConceptsPositionDisplacementR + y1PositionDisplacement) & " \absw1214{\*\atnid IMPORTE}", sErrorDescription)
									End If
									lErrorNumber = AppendTextToFile(Replace(sDocumentName, "<INDEX />", lFileCounter), "\fs14", sErrorDescription)
									lErrorNumber = AppendTextToFile(Replace(sDocumentName, "<INDEX />", lFileCounter), FormatNumber(lConceptAmount, 2, True, False, True), sErrorDescription)
									lErrorNumber = AppendTextToFile(Replace(sDocumentName, "<INDEX />", lFileCounter), "\par}", sErrorDescription)
								...
								Else
									lConceptAmount = CDbl(oRecordset.Fields("TotalAmount").Value)
									'asConceptsD = asConceptsD & "D " & SECOND_LIST_SEPARATOR & CStr(oRecordset.Fields("ConceptShortName").Value) & SECOND_LIST_SEPARATOR & CStr(oRecordset.Fields("ConceptAmount").Value) & SECOND_LIST_SEPARATOR & CStr(oRecordset.Fields("RecordDate").Value) & LIST_SEPARATOR
									If StrComp(oRecordset.Fields("ToAccountNumber").Value, ".", vbBinaryCompare) = 0 Then ' CONCEPTO1
										lErrorNumber = AppendTextToFile(Replace(sDocumentName, "<INDEX />", lFileCounter), "{\pard \pvpg\phpg \posx" & CInt(6240 + x1PositionDisplacement) & "\posy" & CInt(yPositionForConceptsD + lConceptsPositionDisplacement + y1PositionDisplacement) & " \absw737{\*\atnid CAVE.CPTO.} {\*\atnid CONCEPTO1}", sErrorDescription)
									Else
										lErrorNumber = AppendTextToFile(Replace(sDocumentName, "<INDEX />", lFileCounter), "{\pard \pvpg\phpg \posx" & CInt(6240 + x1PositionDisplacement) & "\posy" & CInt(yPositionForConceptsD + 200 + lConceptsPositionDisplacementR + y1PositionDisplacement) & " \absw737{\*\atnid CAVE.CPTO.} {\*\atnid CONCEPTO1}", sErrorDescription)
									End If
									lErrorNumber = AppendTextToFile(Replace(sDocumentName, "<INDEX />", lFileCounter), "\fs14", sErrorDescription)
									lErrorNumber = AppendTextToFile(Replace(sDocumentName, "<INDEX />", lFileCounter), CStr(oRecordset.Fields("ConceptShortName").Value), sErrorDescription)
									lErrorNumber = AppendTextToFile(Replace(sDocumentName, "<INDEX />", lFileCounter), "\par}", sErrorDescription)
									If StrComp(oRecordset.Fields("ToAccountNumber").Value, ".", vbBinaryCompare) = 0 Then ' DESCRIPCION
										lErrorNumber = AppendTextToFile(Replace(sDocumentName, "<INDEX />", lFileCounter), "{\pard \pvpg\phpg \posx" & CInt(6800 + x1PositionDisplacement) & "\posy" & CInt(yPositionForConceptsD + lConceptsPositionDisplacement + y1PositionDisplacement) & " \absw3515{\*\atnid DESCRIPCION}", sErrorDescription)
									Else
										lErrorNumber = AppendTextToFile(Replace(sDocumentName, "<INDEX />", lFileCounter), "{\pard \pvpg\phpg \posx" & CInt(6800 + x1PositionDisplacement) & "\posy" & CInt(yPositionForConceptsD + 200 + lConceptsPositionDisplacementR + y1PositionDisplacement) & " \absw3515{\*\atnid DESCRIPCION}", sErrorDescription)
									End If
									lErrorNumber = AppendTextToFile(Replace(sDocumentName, "<INDEX />", lFileCounter), "\fs14", sErrorDescription)
									lErrorNumber = AppendTextToFile(Replace(sDocumentName, "<INDEX />", lFileCounter), CStr(oRecordset.Fields("ConceptName").Value), sErrorDescription)
									lErrorNumber = AppendTextToFile(Replace(sDocumentName, "<INDEX />", lFileCounter), "\par}", sErrorDescription)
									...
									If InStr(1, S_CREDITS_ID, "," & CInt(oRecordset.Fields("ConceptID").Value) & ",", vbBinaryCompare) > 0 Then
										If CDbl(oRecordset.Fields("ConceptRetention").Value) > 0 Then
											If StrComp(oRecordset.Fields("ToAccountNumber").Value, ".", vbBinaryCompare) = 0 Then ' CONTADOR
												lErrorNumber = AppendTextToFile(Replace(sDocumentName, "<INDEX />", lFileCounter), "{\pard \pvpg\phpg \posx" & CInt(9000 + x1PositionDisplacement) & "\posy" & CInt(yPositionForConceptsD + lConceptsPositionDisplacement + y1PositionDisplacement) & " \absw1214{\*\atnid CONTADOR}", sErrorDescription)
											Else
												lErrorNumber = AppendTextToFile(Replace(sDocumentName, "<INDEX />", lFileCounter), "{\pard \pvpg\phpg \posx" & CInt(9000 + x1PositionDisplacement) & "\posy" & CInt(yPositionForConceptsD + 200 + lConceptsPositionDisplacementR + y1PositionDisplacement) & " \absw1214{\*\atnid CONTADOR}", sErrorDescription)
											End If
											lErrorNumber = AppendTextToFile(Replace(sDocumentName, "<INDEX />", lFileCounter), "\fs14", sErrorDescription)
									...
									If StrComp(oRecordset.Fields("ToAccountNumber").Value, ".", vbBinaryCompare) = 0 Then ' IMPORTE
										lErrorNumber = AppendTextToFile(Replace(sDocumentName, "<INDEX />", lFileCounter), "{\pard \pvpg\phpg \posx" & CInt(10524 + x1PositionDisplacement) & "\posy" & CInt(yPositionForConceptsD + lConceptsPositionDisplacement + y1PositionDisplacement) & " \absw1214{\*\atnid IMPORTE}", sErrorDescription)
									Else
										lErrorNumber = AppendTextToFile(Replace(sDocumentName, "<INDEX />", lFileCounter), "{\pard \pvpg\phpg \posx" & CInt(10524 + x1PositionDisplacement) & "\posy" & CInt(yPositionForConceptsD + 200 + lConceptsPositionDisplacementR + y1PositionDisplacement) & " \absw1214{\*\atnid IMPORTE}", sErrorDescription)
									End If
									lErrorNumber = AppendTextToFile(Replace(sDocumentName, "<INDEX />", lFileCounter), "\fs14", sErrorDescription)
									lErrorNumber = AppendTextToFile(Replace(sDocumentName, "<INDEX />", lFileCounter), FormatNumber(lConceptAmount, 2, True, False, True), sErrorDescription)
									lErrorNumber = AppendTextToFile(Replace(sDocumentName, "<INDEX />", lFileCounter), "\par}", sErrorDescription)
