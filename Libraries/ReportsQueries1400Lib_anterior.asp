...
'		sCondition = sCondition & " And ((EmployeesHistoryList.PaymentCenterID In (" & aLoginComponent(N_PERMISSION_AREA_ID_LOGIN) & ")) Or (EmployeesHistoryList.AreaID In (" & aLoginComponent(N_PERMISSION_AREA_ID_LOGIN) & ")))"
	...
	ElseIf bPayrollIsClosed Then
		...
		Else
			lErrorNumber = ExecuteSQLQuery(oADODBConnection, "Select EmployeesHistoryListForPayroll.EmployeeID, EmployeesHistoryListForPayroll.EmployeeNumber, EmployeeName, EmployeeLastName, EmployeeLastName2, RFC, EmployeesHistoryListForPayroll.EmployeeTypeID, CompanyName, GroupGradeLevels.GroupGradeLevelShortName, EmployeesHistoryListForPayroll.IntegrationID, Areas.AreaShortName, ConceptShortName, IsDeduction, '' As CheckNumber, AccountNumber, '' As PayrollCLC, PositionShortName, LevelShortName, JourneyShortName, '' As ShiftShortName, Min(RecordDate) As MinRecordDate, Max(RecordDate) As MaxRecordDate, Sum(Payroll_" & lPayrollID & ".ConceptAmount) As TotalAmount From Payroll_" & lPayrollID & ", Concepts, Payrolls, Employees, EmployeesHistoryListForPayroll, GroupGradeLevels, Companies, Areas, Positions, Levels, Journeys, Areas As PaymentCenters, Zones, Zones As Zones2, Zones As ParentZones" & sQueryBegin & " Where (Payroll_" & lPayrollID & ".ConceptID=Concepts.ConceptID) And (Payroll_" & lPayrollID & ".EmployeeID=Employees.EmployeeID) And (Employees.EmployeeID=EmployeesHistoryListForPayroll.EmployeeID) And (EmployeesHistoryListForPayroll.PayrollID=" & CLng(Left(lPayrollID, (Len("00000000")))) & ") And (EmployeesHistoryListForPayroll.CompanyID=Companies.CompanyID) And (EmployeesHistoryListForPayroll.AreaID=Areas.AreaID) And (EmployeesHistoryListForPayroll.PositionID=Positions.PositionID) And (EmployeesHistoryListForPayroll.LevelID=Levels.LevelID) And (EmployeesHistoryListForPayroll.GroupGradeLevelID=GroupGradeLevels.GroupGradeLevelID) And (PaymentCenters.ZoneID=Zones.ZoneID) And (Zones.ParentID=Zones2.ZoneID) And (Zones2.ParentID=ParentZones.ZoneID) And (EmployeesHistoryListForPayroll.JourneyID=Journeys.JourneyID) And (EmployeesHistoryListForPayroll.PaymentCenterID=PaymentCenters.AreaID) And (Payrolls.PayrollID=" & lPayrollID & ") And (Companies.StartDate<=" & lForPayrollID & ") And (Companies.EndDate>=" & lForPayrollID & ") And (Concepts.StartDate<=" & lForPayrollID & ") And (Concepts.EndDate>=" & lForPayrollID & ") And (Areas.StartDate<=" & lForPayrollID & ") And (Areas.EndDate>=" & lForPayrollID & ") And (Positions.StartDate<=" & lForPayrollID & ") And (Positions.EndDate>=" & lForPayrollID & ") And (Levels.StartDate<=" & lForPayrollID & ") And (Levels.EndDate>=" & lForPayrollID & ") And (Journeys.StartDate<=" & lForPayrollID & ") And (Journeys.EndDate>=" & lForPayrollID & ") And (Concepts.ConceptID>0) " & Replace(Replace(sCondition, "EmployeesHistoryList.", "EmployeesHistoryListForPayroll."), "BankAccounts.", "EmployeesHistoryListForPayroll.") & " Group By EmployeesHistoryListForPayroll.EmployeeID, EmployeesHistoryListForPayroll.EmployeeNumber, EmployeeName, EmployeeLastName, EmployeeLastName2, RFC, EmployeesHistoryListForPayroll.EmployeeTypeID, CompanyName, GroupGradeLevels.GroupGradeLevelShortName, EmployeesHistoryListForPayroll.IntegrationID, Areas.AreaShortName, ConceptShortName, IsDeduction, AccountNumber, PositionShortName, LevelShortName, JourneyShortName Order By EmployeesHistoryListForPayroll.EmployeeNumber, Concepts.IsDeduction, ConceptShortName", "ReportsQueries1400Lib.asp", S_FUNCTION_NAME, 000, sErrorDescription, oRecordset)
			Response.Write vbNewLine & "<!-- Query: Select EmployeesHistoryListForPayroll.EmployeeID, EmployeesHistoryListForPayroll.EmployeeNumber, EmployeeName, EmployeeLastName, EmployeeLastName2, RFC, EmployeesHistoryListForPayroll.EmployeeTypeID, CompanyName, GroupGradeLevels.GroupGradeLevelShortName, EmployeesHistoryListForPayroll.IntegrationID, Areas.AreaShortName, ConceptShortName, IsDeduction, '' As CheckNumber, AccountNumber, '' As PayrollCLC, PositionShortName, LevelShortName, JourneyShortName, '' As ShiftShortName, Min(RecordDate) As MinRecordDate, Max(RecordDate) As MaxRecordDate, Sum(Payroll_" & lPayrollID & ".ConceptAmount) As TotalAmount From Payroll_" & lPayrollID & ", Concepts, Payrolls, Employees, EmployeesHistoryListForPayroll, GroupGradeLevels, Companies, Areas, Positions, Levels, Journeys, Areas As PaymentCenters, Zones, Zones As Zones2, Zones As ParentZones" & sQueryBegin & " Where (Payroll_" & lPayrollID & ".ConceptID=Concepts.ConceptID) And (Payroll_" & lPayrollID & ".EmployeeID=Employees.EmployeeID) And (Employees.EmployeeID=EmployeesHistoryListForPayroll.EmployeeID) And (EmployeesHistoryListForPayroll.PayrollID=" & CLng(Left(lPayrollID, (Len("00000000")))) & ") And (EmployeesHistoryListForPayroll.CompanyID=Companies.CompanyID) And (EmployeesHistoryListForPayroll.AreaID=Areas.AreaID) And (EmployeesHistoryListForPayroll.PositionID=Positions.PositionID) And (EmployeesHistoryListForPayroll.LevelID=Levels.LevelID) And (EmployeesHistoryListForPayroll.GroupGradeLevelID=GroupGradeLevels.GroupGradeLevelID) And (PaymentCenters.ZoneID=Zones.ZoneID) And (Zones.ParentID=Zones2.ZoneID) And (Zones2.ParentID=ParentZones.ZoneID) And (EmployeesHistoryListForPayroll.JourneyID=Journeys.JourneyID) And (EmployeesHistoryListForPayroll.PaymentCenterID=PaymentCenters.AreaID) And (Payrolls.PayrollID=" & lPayrollID & ") And (Companies.StartDate<=" & lForPayrollID & ") And (Companies.EndDate>=" & lForPayrollID & ") And (Concepts.StartDate<=" & lForPayrollID & ") And (Concepts.EndDate>=" & lForPayrollID & ") And (Areas.StartDate<=" & lForPayrollID & ") And (Areas.EndDate>=" & lForPayrollID & ") And (Positions.StartDate<=" & lForPayrollID & ") And (Positions.EndDate>=" & lForPayrollID & ") And (Levels.StartDate<=" & lForPayrollID & ") And (Levels.EndDate>=" & lForPayrollID & ") And (Journeys.StartDate<=" & lForPayrollID & ") And (Journeys.EndDate>=" & lForPayrollID & ") And (Concepts.ConceptID>0) " & Replace(Replace(sCondition, "EmployeesHistoryList.", "EmployeesHistoryListForPayroll."), "BankAccounts.", "EmployeesHistoryListForPayroll.") & " Group By EmployeesHistoryListForPayroll.EmployeeID, EmployeesHistoryListForPayroll.EmployeeNumber, EmployeeName, EmployeeLastName, EmployeeLastName2, RFC, EmployeesHistoryListForPayroll.EmployeeTypeID, CompanyName, GroupGradeLevels.GroupGradeLevelShortName, EmployeesHistoryListForPayroll.IntegrationID, Areas.AreaShortName, ConceptShortName, IsDeduction, AccountNumber, PositionShortName, LevelShortName, JourneyShortName Order By EmployeesHistoryListForPayroll.EmployeeNumber, Concepts.IsDeduction, ConceptShortName -->" & vbNewLine
		End If
	Else
		If StrComp(oRequest("CheckConceptID").Item, "69", vbBinaryCompare) = 0 Then
			...
			Do While Not oRecordset.EOF
				...
				If StrComp(sCurrentID, CStr(oRecordset.Fields("EmployeeID").Value), vbBinaryCompare) <> 0 Then
					If Len(sCurrentID) > 0 Then
						...
						adTotal(1) = 0
					End If
					sRowContents = "N|" & Left(CStr(oRecordset.Fields("CompanyName").Value), Len("0"))
