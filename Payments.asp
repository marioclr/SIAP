						...
						Response.Write "<TR>"
							...
							Response.Write "<TD><SELECT NAME=""PaymentType"" ID=""PaymentTypeCmb"" SIZE=""1"" CLASS=""Lists"">"
								...
								Response.Write "<OPTION VALUE=""0"""
                                    If Len(oRequest("PaymentType").Item) > 0 Then
                                    If CInt(oRequest("PaymentType").Item) = 0 Then
                                        Response.Write " SELECTED=""1"""
                                    End If
                                    End If
                                Response.Write ">Cheques</OPTION>"
								Response.Write "<OPTION VALUE=""1"""
                                    If Len(oRequest("PaymentType").Item) > 0 Then
                                    If CInt(oRequest("PaymentType").Item) = 1 Then
                                        Response.Write " SELECTED=""1"""
                                    End If
                                    End If
                                Response.Write ">Depósitos</OPTION>"
							Response.Write "</SELECT></TD>"
						Response.Write "</TR>"
					Response.Write "</TABLE><BR />"
					Response.Write "<INPUT TYPE=""SUBMIT"" NAME=""DisplayResults"" ID=""DisplayResultsBtn"" VALUE=""Realizar Búsqueda"" CLASS=""Buttons"" />"
				...
				Select Case iStep
						...
						Response.Write "<FORM NAME=""PrintFrm"" ID=""PrintFrm"" ACTION=""Payments.asp"" METHOD=""GET"" onSubmit=""return CheckPrintPaymentsFields(this)"">"
							...
							If lErrorNumber = 0 Then
								If Not bAllPrinted Then
									...
									Response.Write "<INPUT TYPE=""SUBMIT"" NAME=""Continue"" ID=""ContinueBtn"" VALUE=""Imprimir Reporte Simple"" CLASS=""Buttons"" onClick=""bReadyToPrint = (iPrintCounter > 0);"" />"
									Response.Write "<IMG SRC=""Images/Transparent.gif"" WIDTH=""100"" HEIGHT=""1"" />"
                                    Response.Write "<INPUT TYPE=""SUBMIT"" NAME=""ContinueDouble"" ID=""ContinueDoubleBtn"" VALUE=""Imprimir Reporte Doble"" CLASS=""Buttons"" onClick=""bReadyToPrint = (iPrintCounter > 0);"" />"
									Response.Write "<IMG SRC=""Images/Transparent.gif"" WIDTH=""100"" HEIGHT=""1"" />"
								End If
							Else
								Response.Write "<BR />"
					...
					Case 4
						Response.Write "<FORM NAME=""PrintFrm"" ID=""PrintFrm"" ACTION=""Payments.asp"" METHOD=""GET"">"
                            ...
                            If Len(oRequest("Continue").Item) > 0 Then
                                lErrorNumber = PrintPayments1(oRequest, oADODBConnection, oRequest("RecordID").Item, sErrorDescription)
                            Else 
